...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Future<void> _loadData(int id) async {
    await context.read<PostCubit>().getPostByID(id!);
  }
                    ...
                    onPressed: () {
                      showDialog(
                          ...
                          builder: (context) => AlertDialog(
                                content: const Text('Bạn có muốn gửi yêu cầu xem xe đến Showroom?'),
                                actions: [
                                  TextButton(
              ...
              children: [
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(motor?.showroomDto?.province ?? 'Đang cập nhật', style: _rightStyle),
                        ],
                      ),
                    ],
                  ),
                ...
                Container(
                  ...
                  child: ListTile(
                    leading: Container(
                      decoration: BoxDecoration(
                        shape: BoxShape.circle, // You can use other shapes or decorations as needed
                        border: Border.all(
