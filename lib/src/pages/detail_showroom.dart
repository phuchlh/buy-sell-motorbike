...
class _DetailShowroomState extends State<DetailShowroom> {
  ...
  Future<void> _loadShowroomByID() async {
    context.read<ShowroomCubit>().getShowroomById(widget.id.toString());
    context.read<PostCubit>().getPostProjectionByShowroomID(widget.id.toString());
    context.read<CommentCubit>().getComments(widget.id);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<ShowroomCubit, ShowroomState>(
                    ...
                    Container(
                      ...
                      child: const Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 1),
                          Text('Đối tác uy tín',
                              style: TextStyle(color: Color.fromARGB(132, 0, 0, 0), fontSize: 16)),
                        ],
                      ),
                    ),
                    SizedBox(height: 5),
  ...
  Widget renderReview(CommentResponse comment, int index) {
    ...
    bool isAvatarUrlExist = comment.customerDto?.avatarUrl != null;
                ...
                Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        _replyReview(
                            context, comment.id.toString(), comment.customerDto?.fullName ?? "");
                      },
                      child: Text(
                        "Trả lời",
                        style: TextStyle(
  ...
  Widget renderComment(List<CommentReviewResponse> commentReviews) {
    ...
    if (commentReviews.isNotEmpty) {
      for (var element in commentReviews) {
        ...
        bool isAvatarUrlExist = element.avatarUrl != null ? true : false;
